...
public class StickWaterFireGame {
   ...
   */ 
   ...
   // TODO 4: Implement this method.
      ...
      if((sInput.compareTo(inputStr) == 0)||(wInput.compareTo(inputStr) == 0)||(fInput.compareTo(inputStr) == 0)||(SInput.compareTo(inputStr) == 0)||(WInput.compareTo(inputStr) == 0)||(FInput.compareTo(inputStr) == 0))
         return true;
      else
         return false; 
   }
   ...
   */
   ...
   // TODO 12: Implement this method.
      ...
      if(!isValidInput(playerChoice)){
         ...
         if((sInput.compareTo(playerChoice) == 0 || SInput.compareTo(playerChoice) == 0) && SInput.compareTo(randomChoice) == 0){
            isTie = true;
            playerWins = false;
         }
         if((sInput.compareTo(playerChoice) == 0 || SInput.compareTo(playerChoice) == 0) && WInput.compareTo(randomChoice) == 0){
            isTie = false;
            playerWins = true;
            playerScore ++;
         }
         if((sInput.compareTo(playerChoice) == 0 || SInput.compareTo(playerChoice) == 0) && FInput.compareTo(randomChoice) == 0){
            isTie = false;
            playerWins = false;
            computerScore ++;
         }
         
         if((wInput.compareTo(playerChoice) == 0 || WInput.compareTo(playerChoice) == 0) && SInput.compareTo(randomChoice) == 0){
            isTie = false;
            playerWins = false;
            computerScore ++;
         }
         if((wInput.compareTo(playerChoice) == 0 || WInput.compareTo(playerChoice) == 0) && WInput.compareTo(randomChoice) == 0){
            isTie = true;
            playerWins = false;
         }
         if((wInput.compareTo(playerChoice) == 0 || WInput.compareTo(playerChoice) == 0) && FInput.compareTo(randomChoice) == 0){
            isTie = false;
            playerWins = true;
            playerScore ++;
         }
         
         if((fInput.compareTo(playerChoice) == 0 || FInput.compareTo(playerChoice) == 0) && SInput.compareTo(randomChoice) == 0){
            isTie = false;
            playerWins = true;
            playerScore ++;
         }
         if((fInput.compareTo(playerChoice) == 0 || FInput.compareTo(playerChoice) == 0) && WInput.compareTo(randomChoice) == 0){
            isTie = false;
            playerWins = false;
            computerScore ++;
         }
         if((fInput.compareTo(playerChoice) == 0 || FInput.compareTo(playerChoice) == 0) && FInput.compareTo(randomChoice) == 0){
            isTie = true;
            playerWins = false;
         }
